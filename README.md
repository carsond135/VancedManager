...
After 3 months of development, we are finally ready to Introduce [Vanced Manager](https://github.com/carsond135/VancedManager) to the masses!!
...
## Contributions
Pull Requests should be made to the [Dev](https://github.com/carsond135/VancedManager) Branch as that is the working branch, master is for Release code only.
...
[![Build](https://github.com/carsond135/VancedManager/actions/workflows/debug.yml/badge.svg?branch=dev)](https://github.com/carsond135/VancedManager/actions/workflows/debug.yml)
